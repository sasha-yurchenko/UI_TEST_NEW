...
class LoginPage:
    ...
    def auth(self, email_field, password_field):
        try:
            ...
            self.driver.find_element(*Locators.email_field_css_selector).send_keys(email_field)
            self.driver.find_element(By.CSS_SELECTOR, self.password_field_css_selector).clear()
            self.driver.find_element(*Locators.password_field_css_selector).send_keys(password_field)
            self.driver.find_element(*Locators.login_button_xpath).click()
            return True
    ...
    def enter_password(self, password_field):
        self.driver.find_element(*Locators.password_field_css_selector).send_keys(password_field)
        self.driver.find_element(*Locators.password_field_css_selector).click()
